...
class EmailUtil:
    ...
    def send_generic_email(
        ...
        """
        Send a generic HTML email with optional attachments and inline images.
        ...
        :param inline_images: Dictionary of Content-ID to file paths for inline images
        """
        ...
        try:
            email_message = EmailMessage(
                subject=subject,
                body=content,
                from_email=_from or f"Medicine Apps <{config('EMAIL_HOST_USER')}>",
                to=to,
